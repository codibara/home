...
export default function Works(){
    return(
        <div className='w-full grid-background'>
            <div className='w-full max-w-[1440px] flex flex-col items-center py-20 lg:py-32 mx-auto' id='works'>
                ...
                <div className='w-full lg:w-11/12 lg:max-w-[1070px] flex flex-col px-4'>
                    <CardCarousel />
                </div>
            </div>
        </div>
